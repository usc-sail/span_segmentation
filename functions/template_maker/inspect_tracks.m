function varargout = inspect_tracks(varargin)
% INSPECT_TRACKS MATLAB GUI for drawing a vocal tract template for use
% with Erik Bresch's 2009 segmentation code
%
% Run as inspect_tracks(videodata, outputfile)
...
% Last Modified by GUIDE v2.5 21-Dec-2016 13:44:45

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @inspect_tracks_OpeningFcn, ...
                   'gui_OutputFcn',  @inspect_tracks_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before inspect_tracks is made visible.
function inspect_tracks_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to inspect_tracks (see VARARGIN)

% Choose default command line output for inspect_tracks
...
if ~isempty(trackframe)
    s=sprintf('Frame %i \n%i ms\nTemplate %i',handles.frame, round(handles.frame/handles.framerate*1000),handles.trackdata{trackframe}.template);
...
% UIWAIT makes inspect_tracks wait for user response (see UIRESUME)
% uiwait(handles.thisgui);


% --- Outputs from this function are returned to the command line.
function varargout = inspect_tracks_OutputFcn(hObject, eventdata, handles) 
